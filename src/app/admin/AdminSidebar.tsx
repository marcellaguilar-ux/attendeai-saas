...
import { LayoutDashboard, Scissors, MessagesSquare, Calendar, CreditCard, LogOut } from 'lucide-react'
      ...
      <div style={{ padding: '20px 16px', borderBottom: '1px solid #1d2429' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <p style={{ color: '#00e5a0', fontSize: 11, fontWeight: 500, letterSpacing: '0.04em', marginTop: 1, textTransform: 'uppercase' }}>
              Super Admin
            </p>
          </div>
        </div>
