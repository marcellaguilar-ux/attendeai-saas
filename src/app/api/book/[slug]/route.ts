    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        html: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
          ...
          <p style="color:#555;margin-top:0">Olá, ${nome}! Seu horário está reservado.</p>
          <div style="background:#f5f5f5;border-radius:10px;padding:16px;margin:20px 0">
            <p style="margin:4px 0"><strong>Serviço:</strong> ${servico}${preco ? ` — R$${Number(preco).toFixed(2).replace('.',',')}` : ''}</p>
